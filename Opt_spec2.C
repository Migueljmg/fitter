...
void Opt::Ajuste(TGraphErrors* gr1)
{
  ...
  */
  ...
  gr1->Fit("f1","R","",290,390);
  */
  

  /*
  //////REG1
  f1->SetParLimits(6,340,350); // 350    
  f1->SetParLimits(7,390,395); //   
  f1->SetParLimits(8,395,410);//
  f1->SetParLimits(9,430,440);//


  gr1->Fit("f1","R","",340,430);
  */
  ...
  /*
  //////REG2
  f1->SetParLimits(6,450,455); // 
  f1->SetParLimits(7,485,495); //   
  f1->SetParLimits(8,495,500);//
  f1->SetParLimits(9,630,640);//
  ...
  */
  ...
  f1->SetParLimits(8,654,658); // 
  f1->SetParLimits(9,670,675);//
  f1->SetParLimits(10,720,730);//
  ...
  /*
  //////REG4
  f1->SetParLimits(6,675,680);//
  f1->SetParLimits(7,717,725); //   
  f1->SetParLimits(8,728,732); //  
  f1->SetParLimits(9,748,752);//
  f1->SetParLimits(10,900,910);//


  gr1->Fit("f1","R","",675,910);
  */
