...
void Opt::Ajuste(TGraphErrors* gr1)
{
  ...
  */
  ...
  /*
  //////REG1
  f1->SetParLimits(6,285,290);//280
  f1->SetParLimits(7,449,452);//450  445,455
  f1->SetParLimits(8,472,475);//470  465,475
  f1->SetParLimits(9,657,660);//655

  gr1->Fit("f1","R","",285,657);
  */
  ...
  /*
  /////REG2
  f1->SetParLimits(6,465,475);//470  465,475
  f1->SetParLimits(7,657,660);//655
  f1->SetParLimits(8,667,673);//671    669
  f1->SetParLimits(9,748,755);//750

  gr1->Fit("f1","R","",472,748);
  */
  ...
  /////REG3
  f1->SetParLimits(6,670,680);//671    669
  f1->SetParLimits(7,748,755);//750
  f1->SetParLimits(8,755,765);//750
  f1->SetParLimits(9,850,860);//750

  gr1->Fit("f1","R","",670,860);
